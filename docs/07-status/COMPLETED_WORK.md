...
| TASK-703 | Create bottom navigation shell | 2026-08-28 | JVM/build verification and Compose UI tests |
| TASK-704 | Implement pull-to-refresh | 2026-08-31 | PullToRefreshBox already implemented; tests passing |
