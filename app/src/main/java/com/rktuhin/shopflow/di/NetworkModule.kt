...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideProductApi(retrofit: Retrofit): com.rktuhin.shopflow.data.remote.api.ProductApi {
        return retrofit.create(com.rktuhin.shopflow.data.remote.api.ProductApi::class.java)
    }
}
